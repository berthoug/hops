 ...
 */ public abstract class RMStateStore extends AbstractService {
  ...
  public static class RMState {
    ...
    List<FSSchedulerNode> fairSchedulerNodes;
    Map<String, List<PreemptionMap>> preemtionMap;
    ...
    public List<FSSchedulerNode> getAllFairSchedulerNodes() throws
            IOException {
    ...
    public List<PreemptionMap> getPreemptionMaps(
            final String ficaId) throws IOException {
      return preemtionMap.get(ficaId);
    }
