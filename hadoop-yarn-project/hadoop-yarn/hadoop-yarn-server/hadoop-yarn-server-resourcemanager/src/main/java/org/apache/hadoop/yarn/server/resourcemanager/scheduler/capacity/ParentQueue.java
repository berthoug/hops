...
public class ParentQueue implements CSQueue {
    ...
    private synchronized void setupQueueConfigs(
        ...
        CSQueueUtils.updateQueueStatistics(
                resourceCalculator, this, parent, clusterResource, minimumAllocation, null);
    ...
    public void submitApplicationAttempt(FiCaSchedulerApp application,
            String userNam, TransactionState transactionState) {
    ...
    public synchronized CSAssignment assignContainers(
            Resource clusterResource, FiCaSchedulerNode node, TransactionState transactionState) {
        ...
        while (canAssign(clusterResource, node)) {
            ...
            CSAssignment assignedToChild
                    = assignContainersToChildQueues(clusterResource, node, transactionState);
            ...
            if (Resources.greaterThan(
                ...
                allocateResource(clusterResource, assignedToChild.getResource(), transactionState);
    ...
    synchronized CSAssignment assignContainersToChildQueues(Resource cluster,
        ...
        for (Iterator<CSQueue> iter = childQueues.iterator(); iter.hasNext();) {
            ...
            assignment = childQueue.assignContainers(cluster, node, transactionState);
            if (LOG.isDebugEnabled()) {
    ...
    public void completedContainer(Resource clusterResource,
      ...
      // Careful! Locking order is important!
            ...
            rmContainer.getContainer().getResource(), transactionState);
    ...
    synchronized void allocateResource(Resource clusterResource,
            Resource resource, TransactionState transactionState) {
        Resources.addTo(usedResources, resource);
        CSQueueUtils.updateQueueStatistics(
                resourceCalculator, this, parent, clusterResource, minimumAllocation, transactionState);
        ++numContainers;
    }
    ...
    public synchronized void updateClusterResource(Resource clusterResource, TransactionState transactionState) {
        ...
        for (CSQueue childQueue : childQueues) {
            childQueue.updateClusterResource(clusterResource, transactionState);
        }
    ...
    public void recoverContainer(Resource clusterResource,
        ...
        // Careful! Locking order is important! 
        synchronized (this) {
            allocateResource(clusterResource, container.getResource(), null);
        }
        if (parent != null) {
