...
public interface CSQueue
   ...
   * of the cluster.
   *
   * @return maximum-capacity of the queue as a funciton of the cumulative
   * capacity
   * of the cluster
   */
   ...
   *
   * @param applicationId
   *     the applicationId of the application being submitted
   * @param user
   ...
   *     the resource of the cluster
   * @param application
   *     application to which the container was assigned
   * @param node
   *     node on which the container completed
   * @param container
   *     completed container,
   ...
   *     container
   * @param childQueue
   *     <code>CSQueue</code> to reinsert in childQueues
   * @param event
   *     event to be sent to the container
   */
   ...
   *
   * @param newlyParsedQueue
   *     new queue to re-initalize from
   * @param clusterResource
