    ...
    public void testPersistLeafCSQueue() throws IOException, InterruptedException {
        ...
        app_0.updateResourceRequests(Collections.singletonList(
                TestUtils.createResourceRequest(ResourceRequest.ANY, 1 * GB, 3, true,
                        priority, recordFactory)), new TransactionStateImpl(-1, TransactionState.TransactionType.RM));
        ...
        Thread.sleep(10000);
        io.hops.metadata.yarn.entity.capacity.CSQueue recoverCSQueue = RMUtilities.getCSQueue(a.getQueuePath());
        ...
        assertEquals(recoverCSQueue.getUsedResourceMemory(), a.getUsedResources().getMemory());
        assertEquals(recoverCSQueue.getUsedResourceVCores(), a.getUsedResources().getVirtualCores());
        assertEquals(recoverCSQueue.getUsedCapacity(), a.getUsedCapacity(), DELTA);
        assertEquals(recoverCSQueue.getAbsoluteUsedCapacity(), a.getAbsoluteUsedCapacity(), DELTA);
