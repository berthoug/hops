...
public class TestFifoScheduler {
  ...
  public void testReconnectedNode() throws Exception {
    ...
    fs.handle(new NodeAddedSchedulerEvent(n1, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
    fs.handle(new NodeAddedSchedulerEvent(n2, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
    fs.handle(new NodeUpdateSchedulerEvent(n1, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
    ...
    fs.handle(new NodeRemovedSchedulerEvent(n1, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
    fs.handle(new NodeAddedSchedulerEvent(n1, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
    fs.handle(new NodeUpdateSchedulerEvent(n1, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
  ...
  public void testBlackListNodes() throws Exception {
    ...
    fs.handle(new NodeUpdateSchedulerEvent(n3, new TransactionStateImpl(-1, TransactionState.TransactionType.RM)));
