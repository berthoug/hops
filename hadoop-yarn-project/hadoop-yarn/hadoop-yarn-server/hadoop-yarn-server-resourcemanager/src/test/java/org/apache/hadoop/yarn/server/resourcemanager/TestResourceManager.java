...
public class TestResourceManager {
  ...
  public void testResourceAllocation()
    ...
    Task t3 =
        new Task(application, priority0, new String[]{ResourceRequest.ANY});
  ...
  public void testNodeHealthReportIsNotNull() throws Exception {
    ...
    nm1.heartbeat();
    nm1.heartbeat();
    Collection<RMNode> values =
        resourceManager.getRMContext().getActiveRMNodes().values();
  ...
  public void testResourceManagerInitConfigValidation() throws Exception {
    ...
    try {
      ...
      if (!e.getMessage()
          .startsWith("Invalid global max attempts configuration")) {
        throw e;
      }
    }
  }
