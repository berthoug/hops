...
public class TestSimulatedFSDataset {
  ...
  public void testStorageUsage() throws IOException {
    ...
    assertEquals(fsdataset.getCapacity() - bytesAdded,
  ...
  public void testInjectionEmpty() throws IOException {
    ...
    for (Block b : blockReport.blockIterable()) {
      ...
      assertEquals(blockIdToLen(b.getBlockId()),
          sfsdataset.getLength(new ExtendedBlock(bpid, b)));
    }
    assertEquals(bytesAdded, sfsdataset.getDfsUsed());
    assertEquals(sfsdataset.getCapacity() - bytesAdded,
        sfsdataset.getRemaining());
  }
  ...
  public void testInvalidate() throws IOException {
    ...
    assertEquals(fsdataset.getCapacity() - bytesAdded + sizeDeleted,
        fsdataset.getRemaining());
