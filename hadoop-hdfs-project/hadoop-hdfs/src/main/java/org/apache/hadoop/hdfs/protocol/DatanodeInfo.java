...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public DatanodeInfo(DatanodeID nodeID, String location, final long capacity,
  ...
  public String getDatanodeReport() {
    ...
    buffer.append(
        "Configured Capacity: " + c + " (" + StringUtils.byteDesc(c) + ")" +
            "\n");
    buffer
        .append("DFS Used: " + u + " (" + StringUtils.byteDesc(u) + ")" + "\n");
    buffer.append("Non DFS Used: " + nonDFSUsed + " (" +
        StringUtils.byteDesc(nonDFSUsed) + ")" + "\n");
    buffer.append(
        "DFS Remaining: " + r + " (" + StringUtils.byteDesc(r) + ")" + "\n");
