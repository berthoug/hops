...
public abstract class AMSimulator extends TaskRunner.Task {
  ...
  public void lastStep() throws YarnException {
    ...
    try {
      primaryRemoteConnection.decreseApplicationCount();
    } catch (RemoteException ex) {
  ...
  public void registerAM() throws YarnException, IOException {
    ...
    LOG.info("HOP :: Registered application " + appId.toString() + " master success <Maximum Resource Capability> : " + response.getMaximumResourceCapability());
  }
